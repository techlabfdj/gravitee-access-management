...
public class UpdateUsernameRule {
    ...
    private Function<User, Single<UserProvider>> userProviderSupplier;
    private AuditService auditService;
    private CredentialService credentialService;
    private LoginAttemptService loginAttemptService;
    private Supplier<Single<User>> userSupplier;

    public Single<User> updateUsername(String username, io.gravitee.am.identityprovider.api.User principal) {
        ...
        return validator.validateUsername(username).andThen(Single.defer(() ->
                userSupplier.get().flatMap(user -> userService
                        ...
                        ).flatMap(user -> getUserProvider(user).flatMap(userProvider -> userProvider.findByUsername(user.getUsername())
    ...
    private Single<UserProvider> getUserProvider(User user) {
        return userProviderSupplier.apply(user);
    }
