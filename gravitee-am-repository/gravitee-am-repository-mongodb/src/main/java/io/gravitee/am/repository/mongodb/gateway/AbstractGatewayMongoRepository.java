...
public abstract class AbstractGatewayMongoRepository extends AbstractMongoRepository {
    ...
    private int cursorMaxTimeInMsManagement;

    @Value("${gateway.mongodb.cursorMaxTime:#{null}}")
    private Integer cursorMaxTimeInMs;
    ...
    private Integer getMaxTimeInMs() {
        return cursorMaxTimeInMs != null ? cursorMaxTimeInMs : cursorMaxTimeInMsManagement;
    }
}
