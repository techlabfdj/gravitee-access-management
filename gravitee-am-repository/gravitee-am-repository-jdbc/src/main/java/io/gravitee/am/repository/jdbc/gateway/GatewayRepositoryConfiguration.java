...
public class GatewayRepositoryConfiguration extends AbstractRepositoryConfiguration {
    ...
    private R2DBCPoolWrapper getOauth2Pool() {
        return (R2DBCPoolWrapper) connectionFactoryProvider.getClientWrapper(Scope.GATEWAY.getName());
    }
    ...
    public DatabaseDialectHelper databaseDialectHelper(R2dbcDialect dialect) {
        String collation = environment.getProperty("gateway.jdbc.collation");
    ...
    public void afterPropertiesSet() throws Exception {
        initializeDatabaseSchema(getOauth2Pool(), environment, Scope.GATEWAY.getName() + ".jdbc.");
    }
