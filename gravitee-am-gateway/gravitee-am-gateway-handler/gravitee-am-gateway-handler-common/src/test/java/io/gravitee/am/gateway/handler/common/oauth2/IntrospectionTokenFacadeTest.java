...
public class IntrospectionTokenFacadeTest {
    ...
    public void should_introspect_access_token_by_dedicated_service_component(){
        ...
        Mockito.when(accessService.introspect("accessToken", false)).thenReturn(Single.just(new JWT(Map.of("jti", "accessId"))));
    ...
    public void should_introspect_refresh_token_by_dedicated_service_component(){
        ...
        Mockito.when(refreshService.introspect("refreshToken", false)).thenReturn(Single.just(new JWT(Map.of("jti", "refreshId"))));
