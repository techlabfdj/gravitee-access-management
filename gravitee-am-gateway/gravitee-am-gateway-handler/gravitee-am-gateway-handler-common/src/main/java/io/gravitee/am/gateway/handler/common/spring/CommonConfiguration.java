...
import io.gravitee.am.gateway.handler.common.role.impl.RoleManagerImpl;
import io.gravitee.am.gateway.handler.common.role.impl.RoleRepositoryImpl;
...
public class CommonConfiguration {
    ...
    @Bean
    public RoleFacade roleRepositoryManager(@Value("${sync.roles.enabled:false}") Boolean enabled) {
        if (enabled) {
