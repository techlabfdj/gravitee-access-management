...
public class RootProvider extends AbstractProtocolProvider {
    ...
    protected void doStart() throws Exception {
        ...
        Handler<RoutingContext> passwordPolicyRequestParseHandler = new PasswordPolicyRequestParseHandler(passwordService, domain, passwordPolicyManager);
        ...
        rootRouter.route(HttpMethod.POST, "/passwordValidation")
                  .handler(clientRequestParseHandlerOptional)
                  .handler(new PasswordValidationHandler(passwordService, userService, domain, passwordPolicyManager));
