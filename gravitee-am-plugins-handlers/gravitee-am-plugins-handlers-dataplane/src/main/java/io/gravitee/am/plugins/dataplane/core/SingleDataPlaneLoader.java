...
public class SingleDataPlaneLoader implements DataPlaneLoader {
    ...
    private static final String DATA_PLANE_GW_URL_KEY = DATA_PLANE_KEY + ".dataPlane.gateway.url";
    ...
    public void load(Consumer<DataPlaneDescription> storage) {
        ...
        var dataPlaneUrl = configuration.getProperty(DATA_PLANE_GW_URL_KEY, String.class, configuration.getProperty("gateway.url", String.class, "http://localhost:8092"));
